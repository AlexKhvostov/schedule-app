...
Документация продукта: [`docs/README.md`](docs/README.md) (читать по порядку). Что доделали в расписании: [`docs/schedule-now.md`](docs/schedule-now.md). UX сетки: [`docs/schedule-ux.md`](docs/schedule-ux.md).
